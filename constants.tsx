...
import { Pose, FocalLength, FilmStock } from './types';
...
export const GEAR_CONFIG = {
  lenses: {
    '35mm': ", shot on 35mm wide-angle lens, f/2.8, environmental context, street photography style",
    '50mm': ", shot on 50mm prime lens, f/1.4, natural eye-level perspective, realistic focal length",
    '85mm': ", shot on 85mm telephoto lens, f/1.8, creamy bokeh background, professional portrait compression"
  } as Record<FocalLength, string>,
  stocks: {
    'Standard Digital': ", digital sensor aesthetics, clean sharp look, high dynamic range",
    'Portra 400': ", Kodak Portra 400 film look, warm skin tones, fine film grain, natural light rendition, subtle color saturation",
    'Ilford HP5': ", monochrome black and white, Ilford HP5 film stock, medium grain, classic contrast, silver gelatin print style, filmic noir",
    'CineStill 800T': ", CineStill 800T cinematic film, tungsten-balanced, halation on highlights, cool shadows, moody cinematic atmosphere"
  } as Record<FilmStock, string>
};
